...
**ADR**
Obliga a dejar el por qué, alternativas descartadas y consecuencias — no solo describir cómo funciona el login.

**C4**
Separa de un vistazo quién usa el sistema, qué piezas lo componen y cómo se comunican, sin mezclar rutas HTTP con visión de producto.

**OpenAPI**
Contrato importable (Swagger, Postman, clientes generados) con tipos, códigos HTTP y Bearer.
